...
void WebGPUCopyCommandList::CopyBuffer(IGraphicsBuffer* src, uint64_t srcOffset,
									  ...
									  uint64_t size)
{
	...
	m_encoder.copyBufferToBuffer(
		srcBuffer->GetBuffer(), srcOffset,
		dstBuffer->GetBuffer(), dstOffset,
		size
	);
}

void WebGPUCopyCommandList::CopyBufferToTexture(IGraphicsBuffer* src, uint64_t srcOffset,
...
void WebGPUComputeCommandList::CopyBuffer(IGraphicsBuffer* src, uint64_t srcOffset,
										 IGraphicsBuffer* dst, uint64_t dstOffset,
										 uint64_t size)
{
	HUSH_ASSERT(m_isRecording, "Command list must be recording");
...
void WebGPUComputeCommandList::CopyBufferToTexture(IGraphicsBuffer* src, uint64_t srcOffset,
												  IGraphicsTexture* dst, uint32_t dstX, uint32_t dstY, uint32_t dstZ,
												  uint32_t width, uint32_t height, uint32_t depth)
{
	HUSH_ASSERT(m_isRecording, "Command list must be recording");
...
void WebGPUComputeCommandList::CopyTextureToBuffer(IGraphicsTexture* src, uint32_t srcX, uint32_t srcY, uint32_t srcZ,
												  IGraphicsBuffer* dst, uint64_t dstOffset,
												  uint32_t width, uint32_t height, uint32_t depth)
{
	HUSH_ASSERT(m_isRecording, "Command list must be recording");
...
void WebGPUGraphicsCommandList::CopyBuffer(IGraphicsBuffer* src, uint64_t srcOffset,
										  IGraphicsBuffer* dst, uint64_t dstOffset,
										  uint64_t size)
{
	HUSH_ASSERT(m_isRecording, "Command list must be recording");
...
void WebGPUGraphicsCommandList::CopyBufferToTexture(IGraphicsBuffer* src, uint64_t srcOffset,
												   IGraphicsTexture* dst, uint32_t dstX, uint32_t dstY, uint32_t dstZ,
												   uint32_t width, uint32_t height, uint32_t depth)
{
	HUSH_ASSERT(m_isRecording, "Command list must be recording");
...
void WebGPUGraphicsCommandList::CopyTextureToBuffer(IGraphicsTexture* src, uint32_t srcX, uint32_t srcY, uint32_t srcZ,
												   IGraphicsBuffer* dst, uint64_t dstOffset,
												   uint32_t width, uint32_t height, uint32_t depth)
{
	HUSH_ASSERT(m_isRecording, "Command list must be recording");
...
void WebGPUGraphicsCommandList::Draw(uint32_t vertexCount, uint32_t instanceCount,
...
void WebGPUGraphicsCommandList::DrawIndexed(uint32_t indexCount, uint32_t instanceCount,
...
void WebGPUGraphicsCommandList::SetIndexBuffer(IGraphicsBuffer* buffer, uint64_t offset)
{
	...
	m_renderPass.setIndexBuffer(indexBuffer->GetBuffer(), wgpu::IndexFormat::Uint32, offset, indexBuffer->GetSize() - offset);
}

void WebGPUGraphicsCommandList::SetViewport(float x, float y, float width, float height, float minDepth, float maxDepth)
{
	HUSH_ASSERT(m_isRecording, "Command list must be recording");
