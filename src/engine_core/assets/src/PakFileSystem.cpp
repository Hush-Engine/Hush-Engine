...
namespace Hush
{
	...
	Result<std::unique_ptr<IFile>, IFile::EError> PakFileSystem::OpenFile(std::filesystem::path /*vfsPath*/,
	...
	Result<std::vector<FileInfo>, IFile::EError> PakFileSystem::ListPath(const std::string_view &path)
	{
