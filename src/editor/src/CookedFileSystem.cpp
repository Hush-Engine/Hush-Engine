...
CookedFileSystem::CookedFileSystem(std::string mountPrefix, std::string_view projectRoot, std::string_view cookedDir)
...
Result<std::unique_ptr<IFile>, IFile::EError> CookedFileSystem::OpenFile(std::filesystem::path vfsPath,
																		 std::filesystem::path path, EFileOpenMode mode)
{
